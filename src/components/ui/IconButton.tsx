  ...
  const renderIcon = () => {
    ...
    switch (currentType) {
      ...
      case 'filter-arrow':
        return (
          <svg className="size-[20px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 5l0-3" style={{ color: resolvedStatus === 'click' ? 'var(--gray-12)' : undefined }} />
            <path d="M12 5l-4-4" stroke={resolvedStatus === 'click' ? 'var(--gray-12)' : 'currentColor'} />
            <path d="M12 5l4-4" stroke={resolvedStatus === 'click' ? 'var(--gray-12)' : 'currentColor'} />
            <path d="M12 19l0 3" />
            <path d="M12 19l-4 4" />
            <path d="M12 19l4 4" />
          </svg>
